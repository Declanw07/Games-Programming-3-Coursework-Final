...
{
	m_topLeftFront = glm::vec3(-10.0f, 10.0f, 10.0f);
	m_bottomLeftFront = glm::vec3(-10.0f, -10.0f, 10.0f);
	m_topRightFront = glm::vec3(10.0f, 10.0f, 10.0f);
	m_bottomRightFront = glm::vec3(10.0f, -10.0f, 10.0f);
	m_topLeftBack = glm::vec3(-10.0f, 10.0f, -10.0f);
	m_topRightBack = glm::vec3(10.0f, 10.0f, -10.0f);
	m_bottomLeftBack = glm::vec3(-10.0f, -10.0f, -10.0f);
	m_bottomRightBack = glm::vec3(10.0f, -10.0f, -10.0f);
