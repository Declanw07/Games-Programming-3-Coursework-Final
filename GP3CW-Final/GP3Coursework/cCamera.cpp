...
void cCamera::setTheProjectionMatrix(float left, float right, float bottom, float top, float nearCP, float farCP)
{

	m_ProjectionMatrix = glm::ortho(left, right, bottom, top, nearCP, farCP);
...
void cCamera::moveTheCameraForward(float distance)
{

	m_cameraPos += getTheCameraUpVector() * distance;

}

void cCamera::moveTheCameraLeft(float distance)
{
}

void cCamera::moveTheCameraRight(float distance)
{
}

void cCamera::moveTheCameraBack(float distance)
{
}
